 ...
 */
final class Version20240421183303 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE facility (id INT AUTO_INCREMENT NOT NULL, house_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, INDEX IDX_105994B26BB74515 (house_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE house (id INT AUTO_INCREMENT NOT NULL, category_id INT NOT NULL, user_id INT DEFAULT NULL, proprietaire_id INT NOT NULL, title VARCHAR(255) NOT NULL, latitude NUMERIC(10, 8) NOT NULL, longitude NUMERIC(11, 8) NOT NULL, address VARCHAR(255) NOT NULL, capacity SMALLINT NOT NULL, num_rooms SMALLINT NOT NULL, num_bedrooms SMALLINT NOT NULL, num_bathrooms SMALLINT NOT NULL, daily_price SMALLINT NOT NULL, description LONGTEXT NOT NULL, actif TINYINT(1) NOT NULL, INDEX IDX_67D5399D12469DE2 (category_id), INDEX IDX_67D5399DA76ED395 (user_id), INDEX IDX_67D5399D76C50E4A (proprietaire_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE images (id INT AUTO_INCREMENT NOT NULL, house_id INT NOT NULL, file VARCHAR(255) NOT NULL, INDEX IDX_E01FBE6A6BB74515 (house_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE rent (id INT AUTO_INCREMENT NOT NULL, house_id INT DEFAULT NULL, user_id INT DEFAULT NULL, proprietaire_id INT DEFAULT NULL, start_date DATE NOT NULL, num_days INT NOT NULL, total_price INT NOT NULL, is_paid TINYINT(1) DEFAULT NULL, end_date DATE DEFAULT NULL, transaction_id VARCHAR(36) DEFAULT NULL, INDEX IDX_2784DCC6BB74515 (house_id), INDEX IDX_2784DCCA76ED395 (user_id), INDEX IDX_2784DCC76C50E4A (proprietaire_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL COMMENT \'(DC2Type:json)\', password VARCHAR(255) NOT NULL, telephone VARCHAR(255) DEFAULT NULL, num_carte_identite VARCHAR(50) DEFAULT NULL, adresse VARCHAR(255) DEFAULT NULL, username VARCHAR(255) NOT NULL, is_active TINYINT(1) NOT NULL, type VARCHAR(50) DEFAULT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE images ADD CONSTRAINT FK_E01FBE6A6BB74515 FOREIGN KEY (house_id) REFERENCES house (id)');
